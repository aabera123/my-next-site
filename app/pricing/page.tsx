      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col px-6 pb-24 pt-10 sm:px-10">
          ...
          <section className="mt-16 text-center">
            ...
            <div className="mx-auto mt-8 flex w-fit items-center gap-3 rounded-full border border-[color:var(--ink)]/10 bg-[color:var(--surface-70)] px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-[color:var(--ink)]/70">
              Billed monthly
              ...
              <div
                ...
                className={`relative flex h-full flex-col justify-between rounded-3xl border p-6 shadow-[0_20px_50px_-40px_rgba(29,28,22,0.35)] ${
                  plan.highlight
                    ...
                    : "border-[color:var(--ink)]/10 bg-[color:var(--surface-80)]"
                }`}
              >
                {plan.highlight ? (
                ...
                <button
                  className={`mt-8 rounded-full px-5 py-2 text-sm font-semibold transition ${
                    plan.highlight
                      ...
                      : "border border-[color:var(--ink)]/15 bg-[color:var(--surface-70)] text-[color:var(--ink)] hover:border-[color:var(--ink)]/30"
                  }`}
                >
                  {plan.cta}
                </button>
          ...
          <section className="mt-20 rounded-3xl border border-[color:var(--ink)]/10 bg-[color:var(--surface-80)] p-8 shadow-[0_30px_80px_-50px_rgba(29,28,22,0.35)]">
            <p className="text-xs uppercase tracking-[0.4em] text-[color:var(--ink)]/60">
              FAQ
            </p>
            <div className="mt-6 grid gap-6 md:grid-cols-3">
              {faqs.map((item) => (
                <div key={item.q} className="rounded-2xl bg-[color:var(--surface)] p-4">
